...
export class OCRService {
    ...
    static async processDocument(
        ...
        try {
            ...
            // Publish OCR Job Started Event
            const ocrJobStartedPublisher = new OCRJobStartedPublisher(
                kafkaWrapper.producer
            );
            await ocrJobStartedPublisher.publish({
                jobId: ocrId,
    ...
    private static async checkImageQuality(
        ...
        try {
            ...
            logger.error("Image quality check failed", LogCategory.OCR, {
                error: error.message,
            });
    ...
    private static async extractWithGoogleVision(
        ...
        try {
            ...
            logger.error("Google Vision extraction failed", LogCategory.OCR, {
                error: error.message,
            });
    ...
    private static async extractWithTesseract(
        ...
        try {
            ...
            logger.error("Tesseract extraction failed", LogCategory.OCR, {
                error: error.message,
            });
