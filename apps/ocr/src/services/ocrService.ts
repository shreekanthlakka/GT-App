...
export class OCRService {
    ...
    private static async fuzzyMatchInventoryItem(
        ...
        try {
            ...
            const getFuseClass = await getFuseInstance();

            const fuse = new getFuseClass(inventoryItems, {
    ...
    private static async fuzzyMatchParty(
        ...
        try {
            ...
            const fuse = new getFuseClass(parties, {
                keys: ["name", "gstNo"],
                threshold: 0.4,
                includeScore: true,
            });
    ...
    private static async fuzzyMatchCustomer(
        ...
        try {
            ...
            const fuse = new getFuseClass(customers, {
